...
@implementation CSStoreMenuView
...
- (void)loadPagePacket:(int)pageIndex {
	...
	if((NSNull*)[pageViewsPacket objectAtIndex:pageIndex] == [NSNull null]) {
		...
		CSStoreMenuPacketView* itemView = [[CSStoreMenuPacketView alloc] initWithFrame:frame items:[packets subarrayWithRange:range] pageIndex:pageIndex];
